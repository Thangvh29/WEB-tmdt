...
export const getDashboardStats = [
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      // --- KPI 2: Orders statuses breakdown (delivered, failed, pending, cancelled) ---
      ...
      // --- KPI 3: Top products by quantity sold (within period) ---
      // unwind items and group by product
      ...
      // --- KPI 7: Conversion estimate: orders / carts created in period (coarse) ---
      ...
      // --- KPI 10: Category sales (by product categories) ---
      // Need category lookup via product -> category; may be heavy for large data. Limit top categories.
