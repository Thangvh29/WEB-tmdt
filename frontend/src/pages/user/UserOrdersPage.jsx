...
import "../../assets/style/user-orders.css"; // CSS styling riêng
...
const UserOrdersPage = () => {
  ...
  const fetchOrders = async () => {
    setLoading(true);
    try {
      // Chỉ truyền status nếu có giá trị
            ...
            orders.map((order) => (
              ...
              >
                ...
                <div className="order-summary">
                  <img
                    src={order.firstItem?.image || "/default-product.png"}
                    alt="Sản phẩm"
                    className="order-image"
                  />
                  <div className="order-info">
                    <p>
                      {order.firstItem?.name || "Sản phẩm"} x{" "}
                      {order.firstItem?.qty || 0}
                    </p>
                    <p>
                      Tổng:{" "}
