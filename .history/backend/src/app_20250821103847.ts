...
// Nếu bạn có passport config, bỏ comment dòng sau, đảm bảo file tồn tại:
...
// Mount routes (nếu file route chưa tồn tại, sẽ throw ngay — nếu chưa có, comment dòng tương ứng)
