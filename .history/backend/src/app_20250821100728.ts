...
// Admin routes
import adminRoutes from './routes/admin/index.routes.js'; // nếu bạn có router tổng hợp admin
...
app.use(
  session({
    secret: config.JWT_SECRET || 'keyboardcat',
    resave: false,
...
// If you have aggregated admin index router, mount it too
if (adminRoutes) {
