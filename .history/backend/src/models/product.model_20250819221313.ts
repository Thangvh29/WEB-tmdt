...
export interface IProduct extends Document {
  ...
  reportCount?: number; // Virtual mới
}
...
// Schema cho Variant
// cspell:ignore biến thể không được vượt
...
// Schema cho Product
// cspell:ignore phẩm buộc không được vượt phải nhất Thương hiệu lượng Danh Trạng thái virtuals
const ProductSchema = new Schema<IProduct>(
  {
    ...
    owner: { type: Schema.Types.ObjectId, ref: 'User', index: true }, // Index mới
...
// Pre-save logic
// cspell:ignore biến thể được định buộc phẩm
...
ProductSchema.index({ owner: 1 }); // Index mới
