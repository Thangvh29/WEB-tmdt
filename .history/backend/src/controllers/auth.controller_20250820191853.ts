...
import type { AuthRequest } from '../middlewares'; // Import AuthRequest interface
// Validation rules
import { registerValidation, loginValidation } from '../validators/auth.validator'; // Fix import path, remove .js
