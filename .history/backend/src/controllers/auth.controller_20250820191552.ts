...
// Validation rules
import type { registerValidation, loginValidation } from '../validators/auth.validator.js'; // Giả sử bạn sẽ tạo file validator riêng
...
export const googleCallback = [
  ...
  async (req: Request, res: Response) => {
    try {
      const user = req.user as any; // Passport sẽ inject user
      ...
      res.redirect('/auth/success'); // Redirect tới route success hoặc frontend route
    } catch (error) {
