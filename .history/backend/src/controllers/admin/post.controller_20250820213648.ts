...
// Create post (admin or user creating public post that needs moderation)
export const createPost = [
  ...
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      // If admin, auto-approve (your model pre-save already does), else default isApproved false
      ...
      await post.save();
      return res.status(201).json({ message: 'Tạo bài đăng thành công', post });
    } catch (err) {
