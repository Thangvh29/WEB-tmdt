...
import type { Request, Response, NextFunction } from 'express'; // Use import type for types
...
// client pseudo
socket.emit('joinConversation', conversationId); // server should implement this in socket handlers
