...
import './passport/index.js'; // nếu có, giữ nguyên; nếu chưa có thì bỏ dòng này

// Public / Auth
import authRoutes from './routes/auth.routes.js';

// Admin routes (đã xây theo các file anh nói)
...
// Chat admin router là factory nhận io -> sẽ mount ở server.ts
