...
import categoryUserRoutes from './routes/user/categories.routes.js';
import userCategoriesRoutes from "./routes/user/categories.routes.js";
...
app.use('/api/admin/posts', commentAdminRoutes);
