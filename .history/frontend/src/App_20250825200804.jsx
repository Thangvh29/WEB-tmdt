...
function App() {
  ...
  {/* 🔹 Quản lý mạng xã hội có Outlet và tab giống ProductsPage */}
  <Route path="social" element={<SocialManagementPage />}>
    <Route index element={<AdminPostsPage />} />
    <Route path="admin-posts" element={<AdminPostsPage />} />
    <Route path="user-posts" element={<UserPostsManagementPage />} />
  </Route>
