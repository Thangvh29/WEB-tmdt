...
function App() {
  ...
  {/* Dashboard mặc định khi vào /admin */}
  ...
  <Route path="statistics" element={<DummyPage title="Thống kê doanh thu" />} />
  <Route path="profile" element={<DummyPage title="Quản lý profile" />} />
  <Route path="users" element={<DummyPage title="Quản lý người dùng" />} />
</Route>
