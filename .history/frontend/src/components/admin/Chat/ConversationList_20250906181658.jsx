    ...
    <div className="space-y-1 p-2">
      {conversations.map((conv) => (
        <div
          ...
          className={`conversation-item flex items-center gap-3 px-3 py-2 cursor-pointer rounded-lg transition-all ${
            selectedId === conv._id ? 'bg-blue-100 shadow-sm' : 'hover:bg-gray-100'
          }`}
        >
          <img
