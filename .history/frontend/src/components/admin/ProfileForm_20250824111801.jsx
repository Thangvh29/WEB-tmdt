  ...
  return (
    <div className="admin-profile-page">
      <div className="card max-w-3xl mx-auto p-6 mt-8">
        <h2 className="text-2xl font-semibold text-center mb-4">Quản lý Profile Admin</h2>

        {message && (
          <p className="hint" role="status" style={{ textAlign: "center", color: "#dc2626", marginBottom: 12 }}>
            {message}
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="profile-header">
            <div className="avatar avatar--lg" style={{ cursor: "pointer" }} onClick={triggerFileSelect}>
            ...
            <div className="profile-info">
              ...
              <div className="actions">
                {/* Primary-style "Thay ảnh đại diện" (same visual weight as Save) */}
                <button
                  type="button"
                ...
                >
                  {/* camera icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" className="icon" style={{ width: 16, height: 16 }} viewBox="0 0 20 20" fill="currentColor">
          ...
          {/* Hidden file input (ensure fully hidden) */}
          <input
            ref={fileInputRef}
            type="file"
            accept="image/*"
