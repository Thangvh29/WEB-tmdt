      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center gap-6">
          <div className="profile-avatar-wrapper relative">
            ...
            {/* small overlay icon button (first) */}
            <button
              type="button"
              onClick={triggerFileSelect}
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              {/* Primary-style "Thay ảnh đại diện" (same style as Save) */}
              <button
                type="button"
                onClick={triggerFileSelect}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-md font-medium transition bg-[#1877f2] hover:bg-[#155dc1] text-white shadow-sm"
              >
                {/* icon */}
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-md font-medium transition text-white shadow-sm ${
        ...
        {/* hidden file input (only one place to choose file) */}
        <input
          ref={fileInputRef}
          type="file"
          accept="image/*"
