...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      <img
  src={product.images?.[0] ? `${backendURL}/${product.images[0]}` : "/placeholder.png"}
  alt={product.name}
...
/>
      ...
      <div className="mt-2 text-red-600 font-semibold">{format(product.priceRange?.min)}{product.priceRange?.max && product.priceRange.min !== product.priceRange.max ? ` - ${format(product.priceRange?.max)}` : ""}</div>
