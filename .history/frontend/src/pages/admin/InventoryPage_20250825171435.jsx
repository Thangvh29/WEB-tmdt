...
import "../../assets/style/admin-products.css";   // để ăn style .tabs .tab như trang sản phẩm
import "../../assets/style/product-list.css";     // dùng grid/card giống trang sản phẩm
import "../../assets/style/inventory-admin.css";  // file của bạn (nếu có)
...
const InventoryPage = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    brand: "",
    type: "",
    stockStatus: "all", // all | in | out
  });
  const [productType, setProductType] = useState("new"); // new | old
  ...
  return (
    <div className="products-page inventory-page">
      ...
      {/* Tabs kiểu giống trang Quản lý sản phẩm */}
      ...
      {/* Thanh lọc giống hệt layout bên Danh mục sản phẩm */}
      <form
